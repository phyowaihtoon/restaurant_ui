...
export class StateStorageService {
  ...
  private readonly menuKey = 'creatip-menu';
  ...
  storeMenu(serializedMenu: string): void {
    sessionStorage.setItem(this.menuKey, serializedMenu);
  }

  getMenu(): string | null {
    return sessionStorage.getItem(this.menuKey);
  }

  clearMenu(): void {
    sessionStorage.removeItem(this.menuKey);
  }
}
