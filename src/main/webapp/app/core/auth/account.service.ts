...
import { MenuService } from 'app/layouts/side-menu/menu.service';
...
export class AccountService {
  ...
  authenticate(identity: Account | null): void {
    console.log('Authenticating user:', identity);
  ...
  private fetch(): Observable<Account> {
    ...
    return this.http.get<IAccountDTO>(url).pipe(
      map((res: IAccountDTO) => {
        //store menu
        this.menuService.setMenu(res.menuTree, true);
        //return account
        return res.account;
      })
    );
